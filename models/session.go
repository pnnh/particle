...
func PutSession(model *PASessionModel) error {
...
func GetSessionById(uid string) (*PASessionModel, error) {
	sqlText := `select * from sessions where uid = :uid;`

	sqlParams := map[string]interface{}{"uid": uid}
	var sqlResults []*PASessionModel
...
func GetSessionByLink(app, link string) (*PASessionModel, error) {
...
// 根据访问用户的地址信息获取匿名会话信息
func GetSessionByAddress(address string) (*PASessionModel, error) {
...
func FindSessionByJwtId(clientId, username, jwtId string) (*PASessionModel, error) {
...
func FindSessionByAccessToken(clientId, accessToken string) (*PASessionModel, error) {
...
func FindSessionByCode(clientId, code string) (*PASessionModel, error) {
